...
#pragma warning restore 649
        ...
        {
            fixed (void* dP = DefaultP, b = _stateBuffer)
                Buffer.MemoryCopy(dP, (byte*)b + POff, PLen, PLen);
        }

        private static readonly uint[] DefaultP =
        {
        ...
        {
            fixed (void* dS0 = DefaultS0, b = _stateBuffer)
                Buffer.MemoryCopy(dS0, (byte*)b + S0Off, S0Len, S0Len);
        }

        private static readonly uint[] DefaultS0 =
        {
        ...
        {
            fixed (void* dS1 = DefaultS1, b = _stateBuffer)
                Buffer.MemoryCopy(dS1, (byte*)b + S1Off, S1Len, S1Len);
        }

        private static readonly uint[] DefaultS1 =
        {
        ...
        {
            fixed (void* dS2 = DefaultS2, b = _stateBuffer)
                Buffer.MemoryCopy(dS2, (byte*)b + S2Off, S2Len, S2Len);
        }

        private static readonly uint[] DefaultS2 =
        {
        ...
        {
            fixed (void* dS3 = DefaultS3, b = _stateBuffer)
                Buffer.MemoryCopy(dS3, (byte*)b + S3Off, S3Len, S3Len);
        }

        private static readonly uint[] DefaultS3 =
        {
