...
public partial class Processor
{
    ...
    public static IEnumerable<int> Match(ReadOnlyMemory<byte> source, int sourceOffset, int sourceMaxOffset, ReadOnlyMemory<byte> match, int matchOffset, int matchLength, int maxCount = int.MaxValue)
    {
    ...
    /// <param name="maxCount">Maximum matches.</param>
    /// <returns>Enumerator for matches.</returns>
    public static List<int> Match(ReadOnlySpan<byte> source, int sourceOffset, int sourceMaxOffset, ReadOnlySpan<byte> match, int maxCount = int.MaxValue)
    {
        if (maxCount < 1) throw new ArgumentException($"{nameof(maxCount)} has value {maxCount} but must be at least 1");
        List<int> res = new();
        int count = 0;
    ...
    /// <param name="matchLength">Length of target.</param>
    /// <returns>Enumerator for matches.</returns>
    public static IEnumerable<int> Match(ReadOnlyMemory<byte> source, int sourceOffset, ReadOnlyMemory<byte> match, int matchOffset, int matchLength)
    ...
    /// <param name="matchLength">Length of target.</param>
    /// <returns>Enumerator for matches.</returns>
    public static IEnumerable<int> Match(ReadOnlyMemory<byte> source, ReadOnlyMemory<byte> match, int matchOffset, int matchLength)
    ...
    /// <param name="match">Target to match.</param>
    /// <returns>Enumerator for matches.</returns>
    public static IEnumerable<int> Match(ReadOnlyMemory<byte> source, int sourceOffset, int sourceMaxOffset, ReadOnlyMemory<byte> match)
    ...
    /// <param name="match">Target to match.</param>
    /// <returns>Enumerator for matches.</returns>
    public static IEnumerable<int> Match(ReadOnlyMemory<byte> source, int sourceOffset, int sourceMaxOffset, string match) =>
    ...
    public static int MatchFirst(ReadOnlyMemory<byte> source, int sourceOffset, int sourceMaxOffset, ReadOnlyMemory<byte> match, int matchOffset, int matchLength)
    {
        foreach (int v in Match(source, sourceOffset, sourceMaxOffset, match, matchOffset, matchLength)) return v;
        return -1;
    }
    ...
    /// <param name="matchLength">Length of target.</param>
    /// <returns>Position of first match or -1 if no match found.</returns>
    public static int MatchFirst(ReadOnlyMemory<byte> source, int sourceOffset, ReadOnlyMemory<byte> match, int matchOffset, int matchLength)
    ...
    /// <param name="matchLength">Length of target.</param>
    /// <returns>Position of first match or -1 if no match found.</returns>
    public static int MatchFirst(ReadOnlyMemory<byte> source, ReadOnlyMemory<byte> match, int matchOffset, int matchLength)
    ...
    /// <param name="match">Target to match.</param>
    /// <returns>Position of first match or -1 if no match found.</returns>
    public static int MatchFirst(ReadOnlyMemory<byte> source, int sourceOffset, int sourceMaxOffset, ReadOnlyMemory<byte> match)
    ...
    public static int MatchLast(ReadOnlyMemory<byte> source, int sourceOffset, int sourceMaxOffset, ReadOnlyMemory<byte> match, int matchOffset, int matchLength)
    {
        int u = -1;
        foreach (int v in Match(source, sourceOffset, sourceMaxOffset, match, matchOffset, matchLength)) u = v;
        return u;
    }
    ...
    /// <param name="matchLength">Length of target.</param>
    /// <returns>Position of last match or -1 if no match found.</returns>
    public static int MatchLast(ReadOnlyMemory<byte> source, int sourceOffset, ReadOnlyMemory<byte> match, int matchOffset, int matchLength)
    ...
    /// <param name="matchLength">Length of target.</param>
    /// <returns>Position of last match or -1 if no match found.</returns>
    public static int MatchLast(ReadOnlyMemory<byte> source, ReadOnlyMemory<byte> match, int matchOffset, int matchLength)
    ...
    /// <param name="match">Target to match.</param>
    /// <returns>Position of last match or -1 if no match found.</returns>
    public static int MatchLast(ReadOnlyMemory<byte> source, int sourceOffset, int sourceMaxOffset, ReadOnlyMemory<byte> match)
