...
namespace Fp
{
    ...
    public partial class Scripting
    {
        ...
        /// <param name="file">File to open, <see cref="Processor.InputFile"/> by default</param>
        /// <returns>Created stream</returns>
        public static Stream openFile(bool asMain, string? file = null) => Processor.Current.OpenFile(asMain, file);

        /// <summary>
        /// Open file for reading and set <see cref="Processor.InputStream"/>
        /// </summary>
        /// <param name="file">File to open, <see cref="Processor.InputFile"/> by default</param>
        /// <returns>Created stream</returns>
        public static Stream openMainFile(string? file = null) => Processor.Current.OpenMainFile(file);

        /// <summary>
        /// Open file in <see cref="Processor.InputDirectory"/> for reading
        /// </summary>
        /// <param name="name">File to open</param>
        /// <returns>Created stream</returns>
        public static Stream openFile(string name) => Processor.Current.OpenFile(name);
        ...
        /// <param name="stream">Stream to close</param>
        public static void closeFile(bool asMain, Stream? stream = null) => Processor.Current.CloseFile(asMain, stream);

        /// <summary>
        /// Close stream and clear <see cref="Processor.InputStream"/>
        /// </summary>
        /// <param name="stream">Stream to close</param>
        public static void closeFile(Stream? stream = null) => Processor.Current.CloseFile(stream);
        ...
        public static Stream openOutputFile(bool asMain, string? extension = null, string? filename = null) =>
            Processor.Current.OpenOutputSubFile(asMain, extension, filename);

        /// <summary>
        /// Open file for writing and set <see cref="Processor.OutputStream"/>
        /// </summary>
        /// <param name="extension">File extension</param>
        /// <param name="filename">File to open, generates path by default</param>
        /// <returns>Created stream</returns>
        public static Stream openOutputFile(string? extension = null, string? filename = null) =>
            Processor.Current.OpenOutputFile(extension, filename);
        ...
        /// <summary>
        /// Open file for writing under folder named by current file's name and set <see cref="Processor.OutputStream"/>
        /// </summary>
        /// <param name="extension">File extension</param>
        /// <param name="filename">File to open, generates path by default</param>
        /// <returns>Created stream</returns>
        public static Stream openOutputSubFile(string? extension = null, string? filename = null)
            => Processor.Current.OpenOutputSubFile(extension, filename);
        ...
        public static void closeOutputFile(bool asMain, Stream? stream = null) =>
            Processor.Current.CloseOutputFile(asMain, stream);

        /// <summary>
        /// Close stream and clear <see cref="Processor.OutputStream"/>
        /// </summary>
        /// <param name="stream">Stream to close</param>
        public static void closeOutputFile(Stream? stream = null) => Processor.Current.CloseOutputFile(stream);
        ...
        /// <param name="file">Path to make parents for</param>
        /// <exception cref="IOException"> when failed to create directories</exception>
        public static void mkParents(string file) => Processor.Current.MkParents(file);
        ...
        /// <param name="dir">Path to make directories to</param>
        /// <exception cref="IOException"> when failed to create directories</exception>
        public static void mkDirs(string? dir = null) => Processor.Current.MkDirs(dir);
        ...
        public static string genPathSub(string? extension = null, string? filename = null, string? mainFile = null,
            bool mkDirs = true) => Processor.Current.GenPathSub(extension, filename, mainFile, mkDirs);
        ...
        public static string genPath(string? extension = null, string? filename = null, string? directory = null,
            string? mainFile = null, bool mkDirs = true) =>
            Processor.Current.GenPath(extension, filename, directory, mainFile, mkDirs);
        ...
        /// <returns>Path</returns>
        /// <exception cref="Exception">If separator is encountered by itself</exception>
        public static string join(params string[] paths) => Processor.Current.Join(paths);
